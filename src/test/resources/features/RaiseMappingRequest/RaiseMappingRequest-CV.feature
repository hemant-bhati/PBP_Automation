@MappingRequestCVHDFC
Feature: Raise Mapping Request of CV HDFC
  ...
  Scenario Outline: Generate Raise mapping request for CV (HDFC)
...
#    Then Click on Tickets
    Examples:
      ...
      |2872665565|188  |Automation User|RJ09RG8899|56000  |D:\PB Partners\POSP\OCR\ICICI\icici_two_wheeler.pdf|hu78pyc76|12596|

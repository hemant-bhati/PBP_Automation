...
Feature: user is able to do the journey of niva
  ...
  Scenario Outline: user is able to run all the journey of niva
    ...
    And  click on premium button of niva plan "<PlanName>","<PlanID>","<SumInsured>"
    ...
    Examples:
      |FullName|MobileNo|eldestmemberage|city|panCard|address|contactEmail|emergencyMobile|dob|occupation|heightFeet|heightInch|weight|spouseName|spouseDOB|spouseOccupation|spouseHeightFeet|spouseHeightInch|spouseWeight|PlanName|PlanID|SumInsured|
      |Test Automation|7701906615|35    |Noida|AYMPB1667K|B123|test@gmail.com|9411073568 |01-01-1998|1|60    |8         |72    |Pooja k   |01-01-2002|5     |60               |4               |68          |HealthReAssure|626  | 500000         |
